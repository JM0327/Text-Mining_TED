...
First plot: We use the geom_text_repel() function to avoid overlapping labels between data points. Some labels show a black line next to them, pointing to the location of the point marked by that label. 
...
This plot shows all the used words in grey and labels a part of words for illustration. According to the plot, the word "warm" and "temperature" are close so these two words are usually used together. 
