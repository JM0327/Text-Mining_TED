...
In order to facilitate data analysis, we assigne numerical values to the categories of AI, Climate Change, and Relationships in the TED dataset. The variable **cate** is used to represent these categories, with AI being represented by number 1, Climate Change by number 2, and Relationships by number 3. This allows for easier tracking of the videos in both supervised and unsupervised learning analyses.
