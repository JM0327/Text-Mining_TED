...
We then present the scatter plot on a log10-log10 scale. Although we expect to see a linear relation from this plot, we observe some deviation from Zipf's law on the right hand side of the chart (low frequency words). The reason of the deviation might be that the text we are analyzing is not a representative sample of the language. For example, the text might contain a lot of technical terms. In other words, there are many specific terms. 
