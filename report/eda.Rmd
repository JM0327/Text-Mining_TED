...
## 4.3 Comparison of videos in term of Keyness

The keyness is associated to terms in a document (or a set of documents) compared to another document (or set of documents). Regarding the below chart, we compute the keyness of terms in text1 compare to all the others. We notice that *unsupervised* and *supervised* are most used in text1 when compared to all the others. This is align with the topic of text1 which is AI.
...
## 4.4 Connections between terms by computing co-occurrence (Link between Words)
