...
In this section, we perform initial investigations on **TED** (transcript each video) to discover pattern and to sport anomalies with the summary statistics and graphical representations. We would like to present the analysis of the word frequency, the comparison of videos in term of lexical diversity, the comparison of videos in term of key words, and the connections between terms by computing co-occurance.

## 4.1 Plot of Frequencies and TF-IDF
...
#sort(apply(TED.tfidf1, 2, max), decreasing = TRUE)[1:10] ->EDA
