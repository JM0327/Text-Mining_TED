...
```
According to this plot, the documents in the category "AI" and "relationships" covers the largest area of each other. It is possible that the documents in these two categories are more similar when compared with the documents in the category "Climate change".
